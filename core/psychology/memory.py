...
整合自psychology_agent/agent/memory_system.py
"""
...
class UserProfile:
    ...
    # Therapy preferences
    preferred_therapy_style: Optional[str] = None
...
class MemorySystem:
    ...
    def get_recent_context(self, user_id: str, days: int = 7) -> str:
        """Get recent conversation context summary"""
...
def get_memory_system(storage_dir: str = "data/user_profiles") -> MemorySystem:
